 ...
 */
public class MdlTblCd1 implements Serializable, IKeyValue {
   ...
   */
  /** 表的名称:TBL_CD1. */
  public static final String TBL_CD1 = "TBL_CD1";
  /** 字段：CD_TYPE. */
  public static final String CD_TYPE = "TBL_CD1.CD_TYPE";
  /** 字段：CD_VAL. */
  public static final String CD_VAL = "TBL_CD1.CD_VAL";
  /** 字段：CD_NM. */
  public static final String CD_NM = "TBL_CD1.CD_NM";
  /** 字段：FST_CRT_DT. */
  public static final String FST_CRT_DT = "TBL_CD1.FST_CRT_DT";
  /** 字段：FST_CRT_TM. */
  public static final String FST_CRT_TM = "TBL_CD1.FST_CRT_TM";
  /** 字段：RNT_UPD_DT. */
  public static final String RNT_UPD_DT = "TBL_CD1.RNT_UPD_DT";
  /** 字段：RNT_UPD_TM. */
  public static final String RNT_UPD_TM = "TBL_CD1.RNT_UPD_TM";
  /** 字段：UPD_USER_ID. */
  public static final String UPD_USER_ID = "TBL_CD1.UPD_USER_ID";
  /** 字段：UPD_VW_ID. */
  public static final String UPD_VW_ID = "TBL_CD1.UPD_VW_ID";
  /* 字段 */
  /** 所有字段名数组. */
  public static final String[] COLUMNS = {
    ...
    MdlTblCd1.CD_VAL,
    MdlTblCd1.CD_NM,
    MdlTblCd1.FST_CRT_DT,
    MdlTblCd1.FST_CRT_TM,
    MdlTblCd1.RNT_UPD_DT,
    MdlTblCd1.RNT_UPD_TM,
    MdlTblCd1.UPD_USER_ID,
    MdlTblCd1.UPD_VW_ID
  };
  /* 主键  */
  /** 所有主键字段名数组. */
  ...
  public Object getValueByKey(String key) {
    Object ret = null;
    if (MdlTblCd1.CD_TYPE.equals(key)) {
      ret = this.getCdType();
    }
    if (MdlTblCd1.CD_VAL.equals(key)) {
      ret = this.getCdVal();
    }
    if (MdlTblCd1.CD_NM.equals(key)) {
      ret = this.getCdNm();
    }
    if (MdlTblCd1.FST_CRT_DT.equals(key)) {
      ret = this.getFstCrtDt();
    }
    if (MdlTblCd1.FST_CRT_TM.equals(key)) {
      ret = this.getFstCrtTm();
    }
    if (MdlTblCd1.RNT_UPD_DT.equals(key)) {
      ret = this.getRntUpdDt();
    }
    if (MdlTblCd1.RNT_UPD_TM.equals(key)) {
      ret = this.getRntUpdTm();
    }
    if (MdlTblCd1.UPD_USER_ID.equals(key)) {
      ret = this.getUpdUserId();
    }
    if (MdlTblCd1.UPD_VW_ID.equals(key)) {
      ret = this.getUpdVwId();
    }
    return ret;
  }
