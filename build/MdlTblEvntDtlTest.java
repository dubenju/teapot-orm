...
/**
 * 表tbl_evnt_dtl的JavaBean类的JUnit测试类.
 * @author dubenju@126.com
 *     这份代码最初是由TeapotOrmGen于2017/08/13 15:40:00.522 +0900自动生成的。
 */
public class MdlTblEvntDtlTest {
  ...
  public void testGetTblName() {
    Assert.assertEquals("获取的表名称与设定值一致：", "TBL_EVNT_DTL", MdlTblEvntDtl.getTblName() );
  }
  ...
  public void testGetEvntId() throws Exception {
    MdlTblEvntDtl mdl = new MdlTblEvntDtl();
  ...
  public void testToString() {
    MdlTblEvntDtl mdl = null;
    StringBuffer stringBuffer = null;
    mdl = new MdlTblEvntDtl();
    ...
    MdlTblEvntDtl mdlAllCol = new MdlTblEvntDtl();
    ...
    Assert.assertEquals(stringBuffer.toString(), mdl.toString());
    Assert.assertEquals(mdlAllCol.getEvntId()
        + "," + mdlAllCol.getUserId()
  ...
  public void testGetValueByKey() {
    ...
    Assert.assertEquals(mdl.getEvntId(),
        mdl.getValueByKey(MdlTblEvntDtl.EVNT_ID));
    Assert.assertEquals(mdl.getUserId(),
        mdl.getValueByKey(MdlTblEvntDtl.USER_ID));
    Assert.assertEquals(mdl.getOprtType(),
        mdl.getValueByKey(MdlTblEvntDtl.OPRT_TYPE));
    Assert.assertEquals(mdl.getFstCrtDt(),
        mdl.getValueByKey(MdlTblEvntDtl.FST_CRT_DT));
    Assert.assertEquals(mdl.getFstCrtTm(),
        mdl.getValueByKey(MdlTblEvntDtl.FST_CRT_TM));
    Assert.assertEquals(mdl.getRntUpdDt(),
        mdl.getValueByKey(MdlTblEvntDtl.RNT_UPD_DT));
    Assert.assertEquals(mdl.getRntUpdTm(),
        mdl.getValueByKey(MdlTblEvntDtl.RNT_UPD_TM));
    Assert.assertEquals(mdl.getUpdUserId(),
        mdl.getValueByKey(MdlTblEvntDtl.UPD_USER_ID));
    Assert.assertEquals(mdl.getUpdVwId(),
        mdl.getValueByKey(MdlTblEvntDtl.UPD_VW_ID));
  ...
  public void testSetValueByKey() {
    MdlTblEvntDtl mdl = new MdlTblEvntDtl();
    java.lang.String evntId = new java.lang.String("evntId");
    mdl.setValueByKey(MdlTblEvntDtl.EVNT_ID, evntId);
    java.lang.String userId = new java.lang.String("userId");
    mdl.setValueByKey(MdlTblEvntDtl.USER_ID, userId);
    java.lang.String oprtType = new java.lang.String("oprtType");
    mdl.setValueByKey(MdlTblEvntDtl.OPRT_TYPE, oprtType);
    java.lang.String fstCrtDt = new java.lang.String("fstCrtDt");
    mdl.setValueByKey(MdlTblEvntDtl.FST_CRT_DT, fstCrtDt);
    java.lang.String fstCrtTm = new java.lang.String("fstCrtTm");
    mdl.setValueByKey(MdlTblEvntDtl.FST_CRT_TM, fstCrtTm);
    java.lang.String rntUpdDt = new java.lang.String("rntUpdDt");
    mdl.setValueByKey(MdlTblEvntDtl.RNT_UPD_DT, rntUpdDt);
    java.lang.String rntUpdTm = new java.lang.String("rntUpdTm");
    mdl.setValueByKey(MdlTblEvntDtl.RNT_UPD_TM, rntUpdTm);
    java.lang.String updUserId = new java.lang.String("updUserId");
    mdl.setValueByKey(MdlTblEvntDtl.UPD_USER_ID, updUserId);
    java.lang.String updVwId = new java.lang.String("updVwId");
    mdl.setValueByKey(MdlTblEvntDtl.UPD_VW_ID, updVwId);
  ...
  public static void checkAll() {
    Method[] testMethods = MdlTblEvntDtlTest.class.getDeclaredMethods();
    Method[] methods = MdlTblEvntDtl.class.getDeclaredMethods();
