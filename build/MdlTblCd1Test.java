...
/**
 * 表tbl_cd1的JavaBean类的JUnit测试类.
 * @author dubenju@126.com
 *     这份代码最初是由TeapotOrmGen于2017/08/13 15:39:59.335 +0900自动生成的。
 */
public class MdlTblCd1Test {
  ...
  public void testGetTblName() {
    Assert.assertEquals("获取的表名称与设定值一致：", "TBL_CD1", MdlTblCd1.getTblName() );
  }
  ...
  public void testToString() {
    ...
    MdlTblCd1 mdlAllCol = new MdlTblCd1();
  ...
  public void testGetValueByKey() {
    ...
    Assert.assertEquals(mdl.getCdType(),
        mdl.getValueByKey(MdlTblCd1.CD_TYPE));
    Assert.assertEquals(mdl.getCdVal(),
        mdl.getValueByKey(MdlTblCd1.CD_VAL));
    Assert.assertEquals(mdl.getCdNm(),
        mdl.getValueByKey(MdlTblCd1.CD_NM));
    Assert.assertEquals(mdl.getFstCrtDt(),
        mdl.getValueByKey(MdlTblCd1.FST_CRT_DT));
    Assert.assertEquals(mdl.getFstCrtTm(),
        mdl.getValueByKey(MdlTblCd1.FST_CRT_TM));
    Assert.assertEquals(mdl.getRntUpdDt(),
        mdl.getValueByKey(MdlTblCd1.RNT_UPD_DT));
    Assert.assertEquals(mdl.getRntUpdTm(),
        mdl.getValueByKey(MdlTblCd1.RNT_UPD_TM));
    Assert.assertEquals(mdl.getUpdUserId(),
        mdl.getValueByKey(MdlTblCd1.UPD_USER_ID));
    Assert.assertEquals(mdl.getUpdVwId(),
        mdl.getValueByKey(MdlTblCd1.UPD_VW_ID));
  ...
  public void testSetValueByKey() {
    MdlTblCd1 mdl = new MdlTblCd1();
    java.lang.String cdType = new java.lang.String("cdType");
    mdl.setValueByKey(MdlTblCd1.CD_TYPE, cdType);
    java.lang.String cdVal = new java.lang.String("cdVal");
    mdl.setValueByKey(MdlTblCd1.CD_VAL, cdVal);
    java.lang.String cdNm = new java.lang.String("cdNm");
    mdl.setValueByKey(MdlTblCd1.CD_NM, cdNm);
    java.lang.String fstCrtDt = new java.lang.String("fstCrtDt");
    mdl.setValueByKey(MdlTblCd1.FST_CRT_DT, fstCrtDt);
    java.lang.String fstCrtTm = new java.lang.String("fstCrtTm");
    mdl.setValueByKey(MdlTblCd1.FST_CRT_TM, fstCrtTm);
    java.lang.String rntUpdDt = new java.lang.String("rntUpdDt");
    mdl.setValueByKey(MdlTblCd1.RNT_UPD_DT, rntUpdDt);
    java.lang.String rntUpdTm = new java.lang.String("rntUpdTm");
    mdl.setValueByKey(MdlTblCd1.RNT_UPD_TM, rntUpdTm);
    java.lang.String updUserId = new java.lang.String("updUserId");
    mdl.setValueByKey(MdlTblCd1.UPD_USER_ID, updUserId);
    java.lang.String updVwId = new java.lang.String("updVwId");
    mdl.setValueByKey(MdlTblCd1.UPD_VW_ID, updVwId);
  ...
  public static void checkAll() {
    Method[] testMethods = MdlTblCd1Test.class.getDeclaredMethods();
    Method[] methods = MdlTblCd1.class.getDeclaredMethods();
