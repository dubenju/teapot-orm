...
/**
 * 表TBL_SQLITE的JavaBean类的JUnit测试类.
 * @author dubenju@126.com
 *     这份代码最初是由TeapotOrmGen于2017/08/13 13:18:13.069 +0900自动生成的。
 */
public class MdlTblSqliteTest {
  ...
  public void testGetTblName() {
    Assert.assertEquals("获取的表名称与设定值一致：", "TBL_SQLITE", MdlTblSqlite.getTblName() );
  }
  ...
  public void testGetTestFloat() throws Exception {
    MdlTblSqlite mdl = new MdlTblSqlite();
    java.lang.Double testFloat = 12345.678d;
  ...
  public void testGetTestDecimal() throws Exception {
    MdlTblSqlite mdl = new MdlTblSqlite();
    java.lang.Double testDecimal = 12345.678d;
  ...
  public void testGetTestDatetime() throws Exception {
    MdlTblSqlite mdl = new MdlTblSqlite();
    java.lang.Long testDatetime = 654321L;
  ...
  public void testGetCreateDate() throws Exception {
    MdlTblSqlite mdl = new MdlTblSqlite();
    java.lang.Long createDate = 654321L;
  ...
  public void testGetCreateTime() throws Exception {
    MdlTblSqlite mdl = new MdlTblSqlite();
    java.lang.Long createTime = 654321L;
  ...
  public void testGetUpdateDate() throws Exception {
    MdlTblSqlite mdl = new MdlTblSqlite();
    java.lang.Long updateDate = 654321L;
  ...
  public void testGetUpdateTime() throws Exception {
    MdlTblSqlite mdl = new MdlTblSqlite();
    java.lang.Long updateTime = 654321L;
  ...
  public void testToString() {
    MdlTblSqlite mdl = null;
    StringBuffer stringBuffer = null;
    mdl = new MdlTblSqlite();
    ...
    MdlTblSqlite mdlAllCol = new MdlTblSqlite();
  ...
  public static void checkAll() {
    Method[] testMethods = MdlTblSqliteTest.class.getDeclaredMethods();
    Method[] methods = MdlTblSqlite.class.getDeclaredMethods();
